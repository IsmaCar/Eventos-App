...
function EventUser() {
  const { getImageUrl } = useEvent()
    ...
    if (error || !events) {
        return (
            <div className="bg-white rounded-lg shadow-md p-8 text-center my-8">
                ...
                <Link to="/profile" className="bg-gradient-to-r from-fuchsia-400 to-indigo-400 text-white px-6 py-2 
    ...
    return (
        <div className="mt-6">
            <div className="container mx-auto px-2 sm:px-3 md:px-4 lg:px-4 xl:px-6">
                ...
                {events && events.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                        <p className="text-gray-500">No has creado eventos aún.</p>
                        <Link
                            to="/create-event"
