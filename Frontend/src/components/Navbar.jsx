...
function Navbar() {
    ...
    // Cierra el tooltip después de 3 segundos
    useEffect(() => {
                        ...
                        {token && (
                            ...
                            rounded-lg hover:bg-zinc-700 transition duration-300 ease-in-out"
                                    ...
                                    >
                                        ...
                                        {showNoNotificationsTooltip && (
                                            <div className="absolute top-12 right-0 bg-zinc-700 text-white text-sm rounded-lg px-4 py-2 shadow-lg z-50 w-48">
                                                No tienes notificaciones nuevas
                                                <div className="absolute -top-2 right-4 w-0 h-0 
                                                border-l-8 border-r-8 border-b-8 
                                                border-l-transparent border-r-transparent border-b-zinc-700"></div>
                                            </div>
                                        )}
                                    </button>
                    ...
                    <div className="md:hidden bg-zinc-800 shadow-lg">
                        <div className="px-4 py-3 space-y-2">
                            ...
                            >
                                ...
                                {/* Tooltip para móvil */}
                                {showNoNotificationsTooltip && (
                                    <div className="absolute top-10 left-0 bg-zinc-700 text-white text-sm rounded-lg px-4 py-2 shadow-lg z-50 w-full">
                                        No tienes notificaciones nuevas
                                    </div>
                                )}
                            </button>
