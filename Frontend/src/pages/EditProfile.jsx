...
// Función para manejar errores de la imagen
...
const handleSubmit = async (e) => {
  ...
  setLoading(true);
  try {
     // Solo validar las contraseñas si el usuario intenta cambiarlas
     if (formData.newPassword || formData.confirmPassword || formData.currentPassword) {
      // Si hay algún campo de contraseña rellenado, verificar que estén todos los necesarios
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-1 flex flex-col items-center">
          <div className="mb-4 relative">
            <img
              src={preview || `${API_URL}/uploads/avatars/${user?.avatar || 'default-avatar.png'}`}
