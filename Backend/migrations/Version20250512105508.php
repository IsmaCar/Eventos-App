...
final class Version20250512105508 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE invitation (id INT AUTO_INCREMENT NOT NULL, event_id INT DEFAULT NULL, inivted_user_id INT DEFAULT NULL, invited_by_id INT DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, INDEX IDX_F11D61A271F7E88B (event_id), INDEX IDX_F11D61A22876AC0C (inivted_user_id), INDEX IDX_F11D61A2A7B4A7E3 (invited_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE invitation ADD CONSTRAINT FK_F11D61A271F7E88B FOREIGN KEY (event_id) REFERENCES event (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE invitation ADD CONSTRAINT FK_F11D61A22876AC0C FOREIGN KEY (inivted_user_id) REFERENCES `user` (id)
        SQL);
        $this->addSql(<<<'SQL'
